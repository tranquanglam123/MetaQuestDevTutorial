...
/// </summary>
public class CustomBttnEventWrapper : MonoBehaviour
{
    /// <summary>
    ...
    public UnityEvent WhenHover { get { return _whenHover; } private set { } }
    public UnityEvent WhenUnhover { get { return _whenUnhover; } private set { } }
